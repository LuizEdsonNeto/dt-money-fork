            ...
            <tbody>
               {data.map(transaction => (
                <tr key={transaction.id} className="h-16">
                   ...
                   <td className="px-4 py-4 whitespace-nowrap text-center bg-white rounded-r-lg">
                       <button 
                           onClick={() => onEdit(transaction)}
                           className="text-blue-500 hover:text-blue-700 font-medium mr-4 transition-colors"
                       >
                           Editar
                       </button>
                       <button 
                           onClick={() => onDelete(transaction)}
                           className="text-outcome hover:brightness-90 font-medium transition-colors"
                       >
                           Excluir
                       </button>
                   </td>
